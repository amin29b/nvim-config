...
if &background ==# 'dark'
  ...
  hi SpecialChar guifg=#107777 guibg=NONE 
  ...
  hi TODO            guifg=#661111 guibg=NONE gui=bold,underline cterm=bold,underline
  hi NOTE            guifg=#119911 guibg=NONE gui=bold,underline cterm=bold,underline
  hi STUDY           guifg=#FFFF11 guibg=NONE gui=bold,underline cterm=bold,underline
  hi IMPORTANT       guifg=#FFFF11 guibg=NONE gui=bold,underline cterm=bold,underline
  hi FIXME           guifg=#999910 guibg=NONE gui=bold,underline cterm=bold,underline
  hi BUG             guifg=#999910 guibg=NONE gui=bold,underline cterm=bold,underline
  hi ExtraWhiteSpace guifg=NONE    guibg=#113211 

  hi   OilDir              guifg=#7aa2f7 gui=bold
  hi   OilFile             guifg=#c0caf5 guibg=NONE 

  hi EndOfBuffer           guifg =NONE  guibg =#111120
  hi NormalFloat           guifg =NONE   guibg =NONE

  hi LineNr       guifg=#303030 guibg=#101010 gui=NONE cterm=NONE
  hi Cursor       guibg=#2CFF05 guifg=NONE    "gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi CursorColumn guifg=NONE    guibg=#303030 gui=NONE    cterm=NONE
  hi CursorLine   guifg=NONE    guibg=#101055 gui=NONE    cterm=NONE
  hi CursorLineNr guifg=#dadada guibg=#101080 gui=NONE    cterm=NONE
  hi CursorIM     guifg=#000000 guibg=#afff00 gui=NONE    cterm=NONE

  "hi ASSERT                guifg=#10FF80
  hi qfError               guifg=#FF0000 guibg=NONE gui=bold
  hi qfWarning             guifg=#FFFF00 guibg=NONE gui=bold
  hi qfText                guifg=#EEEEEE guibg=#111111 
  hi qfLineNr              guifg=#111111 guibg=#555555 
  hi QuickFixLine          guifg=#999999 guibg=#551155   gui=reverse   cterm=reverse
  "hi HighlighCursorWord    guibg=#101F3F
  hi HighlighCursorWord    guibg=#202000
  hi DimEmptyLine          guibg=#101010
  ...
  hi Comment  guifg=#5A5A5A guibg=NONE "gui=bold cterm=bold
  "hi ASSERT   guifg=#FE401C
  hi ASSERT   guifg=#FF8A18  gui=bold
  hi MARKER   guifg=#101010   guibg=#00FF00 gui=bold
  "hi TYPES  guifg=#B0F0FF guibg=NONE
  "hi CONST2 guifg=#309930 guibg=NONE 
  "hi BRANCH guifg=#1080FF guibg=NONE 
  
  "hi TYPES  guifg=#10FFFF guibg=NONE
  "hi TYPES  guifg=#FA9944 guibg=NONE
  "hi TYPES  guifg=#7A36DE guibg=NONE
  "hi TYPES  guifg=#6C32A0 guibg=NONE
  "hi TYPES  guifg=#813CBF guibg=NONE
  hi TYPES  guifg=#A24BF0 guibg=NONE
  "hi CONST2 guifg=#10FF10 guibg=NONE 
  "hi CONST2 guifg=#F0F360 guibg=NONE 
  "hi CONST2 guifg=#913323 guibg=NONE    gui=bold
  hi CONST2 guifg=#da9a7a guibg=NONE    gui=bold
  "hi BRANCH guifg=#1010FF guibg=NONE   gui=bold
  "hi BRANCH guifg=#DB9C00 guibg=NONE   gui=bold
  "hi BRANCH guifg=#956911 guibg=NONE   gui=bold
  "hi BRANCH guifg=#AD863E guibg=NONE   gui=bold
  "hi BRANCH guifg=#FF8A18 guibg=NONE   gui=bold
  hi BRANCH guifg=#FFCA18 guibg=NONE   "gui=bold
