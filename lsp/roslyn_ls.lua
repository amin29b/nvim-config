...
return {
 ...
 --         virtual_text = { severity = { min = vim.diagnostic.severity.ERROR, max = vim.diagnostic.severity.WARN } }, 
 --         signs = { severity = { min = vim.diagnostic.severity.ERROR, max = vim.diagnostic.severity.WARN } }, 
 --         underline = { severity = { min = vim.diagnostic.severity.ERROR, max = vim.diagnostic.severity.WARN } }, 
 --         float = { severity = { min = vim.diagnostic.severity.ERROR, max = vim.diagnostic.severity.WARN } }, 
 --     }, vim.lsp.diagnostic.get_namespace(client.id))  -- Uses the LSP client's namespace for specificity
 -- end,
}
